...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        fabAdd.setOnClickListener{
            addMessage()
            count.text = "Contador: " + messages.size.toString()
        }
    }
    ...
    private  fun addMessage() {
        ...
        if ( edtTitle.text.toString().isEmpty() && edtText.text.toString().isEmpty() ) {
            Toast.makeText(this, "Dados em branco", Toast.LENGTH_SHORT).show()
        } else {
